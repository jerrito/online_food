class AppStrings {
  ...
  static String unregisteredNumber = "Number is not registered";
  static String selfTransfer = "You can't transfer to your self";
  static String networkError = "Network connection error";
  static String samePhoneNumber = "User number provided already";
  static String verificationFail = "Verification failed. Please try again";
  ...
  static String success = "Successfully registered";
